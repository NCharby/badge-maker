...
-- Note: schema.sql contained a duplicate of the above policy (lines 167-169).
-- The duplicate is removed here so that supabase db reset works correctly
-- on a fresh local dev database. The original schema.sql is preserved as-is.
